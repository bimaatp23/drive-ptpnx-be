...
DataRouter.put("/:id", authenticateJWT, DataParser.none(), async (req: JWTRequest, res: Response) => {
...
DataRouter.delete("/:id", authenticateJWT, async (req: JWTRequest, res: Response) => {
