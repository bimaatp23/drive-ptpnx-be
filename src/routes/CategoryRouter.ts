...
CategoryRouter.post("/update", DataParser.none(), async (req: JWTRequest, res: Response) => {
...
CategoryRouter.post("/delete", DataParser.none(), async (req: JWTRequest, res: Response) => {
